...
```typescript
public associateWithVoiceConnector(voiceConnectorId: ChimeVoiceConnector): void
```
...
### KinesisVideoStreamPool <a name="KinesisVideoStreamPool" id="cdk-amazon-chime-resources.KinesisVideoStreamPool"></a>

#### Initializers <a name="Initializers" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer.parameter.props">props</a></code> | <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolProps">KinesisVideoStreamPoolProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer.parameter.id"></a>

- *Type:* string

---

##### `props`<sup>Required</sup> <a name="props" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.Initializer.parameter.props"></a>

- *Type:* <a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolProps">KinesisVideoStreamPoolProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.toString">toString</a></code> | Returns a string representation of this construct. |

---

##### `toString` <a name="toString" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.isConstruct"></a>

```typescript
import { KinesisVideoStreamPool } from 'cdk-amazon-chime-resources'

KinesisVideoStreamPool.isConstruct(x: any)
```

Checks if `x` is a construct.

###### `x`<sup>Required</sup> <a name="x" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.createdTimestamp">createdTimestamp</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolArn">poolArn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolId">poolId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolName">poolName</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolStatus">poolStatus</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPool.property.updatedTimestamp">updatedTimestamp</a></code> | <code>string</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.node"></a>
...
##### `createdTimestamp`<sup>Required</sup> <a name="createdTimestamp" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.createdTimestamp"></a>
...
##### `poolArn`<sup>Required</sup> <a name="poolArn" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolArn"></a>
...
##### `poolId`<sup>Required</sup> <a name="poolId" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolId"></a>
...
##### `poolName`<sup>Required</sup> <a name="poolName" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolName"></a>
...
##### `poolStatus`<sup>Required</sup> <a name="poolStatus" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.poolStatus"></a>
...
##### `updatedTimestamp`<sup>Required</sup> <a name="updatedTimestamp" id="cdk-amazon-chime-resources.KinesisVideoStreamPool.property.updatedTimestamp"></a>
...
### KinesisVideoStreamConfiguration <a name="KinesisVideoStreamConfiguration" id="cdk-amazon-chime-resources.KinesisVideoStreamConfiguration"></a>

#### Initializer <a name="Initializer" id="cdk-amazon-chime-resources.KinesisVideoStreamConfiguration.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamConfiguration.property.region">region</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamConfiguration.property.dataRetentionInHours">dataRetentionInHours</a></code> | <code>number</code> | *No description.* |

---

##### `region`<sup>Required</sup> <a name="region" id="cdk-amazon-chime-resources.KinesisVideoStreamConfiguration.property.region"></a>
...
##### `dataRetentionInHours`<sup>Optional</sup> <a name="dataRetentionInHours" id="cdk-amazon-chime-resources.KinesisVideoStreamConfiguration.property.dataRetentionInHours"></a>
...
### KinesisVideoStreamPoolProps <a name="KinesisVideoStreamPoolProps" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolProps"></a>

#### Initializer <a name="Initializer" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.streamConfiguration">streamConfiguration</a></code> | <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamConfiguration">KinesisVideoStreamConfiguration</a></code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.clientRequestToken">clientRequestToken</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.poolName">poolName</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.tags">tags</a></code> | <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolTag">KinesisVideoStreamPoolTag</a>[]</code> | *No description.* |

---

##### `streamConfiguration`<sup>Required</sup> <a name="streamConfiguration" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.streamConfiguration"></a>

```typescript
public readonly streamConfiguration: KinesisVideoStreamConfiguration;
```

- *Type:* <a href="#cdk-amazon-chime-resources.KinesisVideoStreamConfiguration">KinesisVideoStreamConfiguration</a>

---

##### `clientRequestToken`<sup>Optional</sup> <a name="clientRequestToken" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.clientRequestToken"></a>
...
##### `poolName`<sup>Optional</sup> <a name="poolName" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.poolName"></a>
...
##### `tags`<sup>Optional</sup> <a name="tags" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolProps.property.tags"></a>

```typescript
public readonly tags: KinesisVideoStreamPoolTag[];
```

- *Type:* <a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolTag">KinesisVideoStreamPoolTag</a>[]

---

### KinesisVideoStreamPoolTag <a name="KinesisVideoStreamPoolTag" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolTag"></a>

#### Initializer <a name="Initializer" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolTag.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolTag.property.key">key</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdk-amazon-chime-resources.KinesisVideoStreamPoolTag.property.value">value</a></code> | <code>string</code> | *No description.* |

---

##### `key`<sup>Required</sup> <a name="key" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolTag.property.key"></a>
...
##### `value`<sup>Required</sup> <a name="value" id="cdk-amazon-chime-resources.KinesisVideoStreamPoolTag.property.value"></a>
...
| <code><a href="#cdk-amazon-chime-resources.PhoneCountry.GB">GB</a></code> | *No description.* |
...
##### `GB` <a name="GB" id="cdk-amazon-chime-resources.PhoneCountry.GB"></a>
